...
public class CardSystem : Singleton<CardSystem>
{
    ...
    private void OnEnable()
    {
        ...
        ActionSystem.AttachPerformer<PlayCardGA>(PlayCardPerfomer); 
    }
    ...
    private IEnumerator DrawCardsPerformer(DrawCardsGA drawCardsGA)
    {
        ...
        int notDrawnAmount = drawCardsGA.Amout - actualAmount;
    ...
    public IEnumerator PlayCardPerfomer(PlayCardGA playCardGA)
    {
